...
SOCIAL_AUTH_TDT_KEY_DEV = 'TDTOJ_APP_CLIENT_TEST'
SOCIAL_AUTH_TDT_KEY_PROD = 'TDTOJ_APP_CLIENT'
SOCIAL_AUTH_TDT_SECRET = 'iwuiwoeu28782iwueiuejad'
SOCIAL_AUTH_TDT_REDIRECT_URI_DEV = 'http://188.166.254.61:8080/complete/tdt'
SOCIAL_AUTH_TDT_REDIRECT_URI_PROD = 'https://tdtoj.duthu.net/complete/tdt'
